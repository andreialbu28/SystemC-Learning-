...
OBJS="$BUILD_DIR/module_A.o $BUILD_DIR/module_B.o $BUILD_DIR/module_C.o $BUILD_DIR/main.o "
...
case "$1" in
    all)
        ...
        compile_cpp src/module_A.cpp $BUILD_DIR/module_A.o
        compile_cpp src/module_B.cpp $BUILD_DIR/module_B.o
        compile_cpp src/module_C.cpp $BUILD_DIR/module_C.o
